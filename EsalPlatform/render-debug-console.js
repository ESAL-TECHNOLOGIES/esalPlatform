...
(function() {
  ...
  function logError(error, source, additional = {}) {
    ...
    // Categorize error
    if (errorData.message.includes('useState') || errorData.message.includes('Cannot read properties of null')) {
    ...
    } else if (errorData.message.includes('React') || errorData.message.includes('react')) {
  ...
  function analyzeReactState() {
    ...
    try {
      ...
      console.log('React-related scripts:', reactScripts.map(s => s.src));
      ...
      console.log('DOM elements with id root:', document.getElementById('root'));
  ...
  function monitorReactHooks() {
    if (window.React && window.React.useState) {
      ...
      console.warn('⚠️ Cannot monitor React hooks - React.useState not available');
    }
  }
  ...
  console.log('  - window.renderDebug.getUseStateErrors() - Get useState errors');
