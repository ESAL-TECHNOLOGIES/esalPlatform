...
export const setupDebugging = () => {
  ...
  console.log(
    "✅ React debugging setup complete. Access via window.reactDebug"
  );
...
export const showDebugInfo = () => {
  ...
  console.log(
    "useState errors:",
    errors.filter((e) => e.error.message.includes("useState"))
  );
