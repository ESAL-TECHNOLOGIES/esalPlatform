...
(function () {
  ...
  console.log(
    "🚀 Initializing Production React Debug for Render Deployment..."
  );
  ...
  function initialize() {
    ...
    window.debugReact = {
      ...
      useStateErrors: () =>
        errorLog.filter((e) => e.message && e.message.includes("useState")),
    };

    console.log(
      "✅ Production debug initialized. Use window.debugReact to access debug functions."
    );
    console.log("📊 Commands available:");
    console.log("  - window.debugReact.getErrors() - Get all errors");
    console.log(
      "  - window.debugReact.useStateErrors() - Get useState specific errors"
    );
    console.log(
      "  - window.debugReact.checkEnvironment() - Check React environment"
    );
    console.log(
      "  - window.debugReact.analyzeBundles() - Analyze loaded bundles"
    );
  }
